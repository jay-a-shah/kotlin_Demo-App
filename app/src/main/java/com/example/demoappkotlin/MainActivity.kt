    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        androiduibtn.setOnClickListener {
            val normalToast = Toast.makeText(
                applicationContext, "Moving Towards new Activity",
                Toast.LENGTH_SHORT
            )
            normalToast.setGravity(Gravity.TOP, 0, 0)
            normalToast.show()
            val intent = Intent(applicationContext, AndroidUI::class.java)
            startActivity(intent)
        }
        //Different Layout Activity Button
        val differentLayoutBtn = findViewById<Button>(R.id.different_layout_activity_btn)
        differentLayoutBtn.setOnClickListener {
            val intent = Intent(applicationContext, LayoutActivity::class.java)
            startActivity(intent)
        }
        //List view and Recycler view Button
        val listViewBtn = findViewById<Button>(R.id.list_view_btn)
        listViewBtn.setOnClickListener {
            val intent = Intent(applicationContext,com.example.demoappkotlin.listView_ViewPager.ListViewActivity::class.java)
            startActivity(intent)
        }
