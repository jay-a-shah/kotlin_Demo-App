...
class ExpandableRecyclerViewAdapter(var list: ArrayList<ModelExpandableRecyclerView>): RecyclerView.Adapter<ExpandableRecyclerViewAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemview = LayoutInflater.from(parent.context).inflate(R.layout.item_expandable_recycler_view, parent, false)
    ...
    class MyViewHolder(itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        val title: TextView = itemview.findViewById(R.id.tvTitleExpandableRecycler)
